/// Use this class's constructor to get `ISO 639-1 language code` of different languages
/// ```
/// String apiKey = 'Your secret api key';
/// Tenor api = Tenor(apiKey: '$apiKey', language: TenorLanguage.English);
/// ```
class TenorLanguage {
  ...
  static const Norwegian_Bokmal = 'nb';
  static const Norwegian_Nynorsk = 'nn';
  ...
  /// Needs to check once
  static const Simplified_Chinese = 'zh';
  ...
  /// Needs to check once
  static const Traditional_Chinese = 'zh';
